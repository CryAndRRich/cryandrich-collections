...
-- 4. Write a query to display the name (first_name, last_name) and hire date 
...
-- 7. Write a query to display the last name of employees 
...
-- 11. Write a query to select all records from employees 
