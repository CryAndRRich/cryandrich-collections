...
BACKUP DATABASE [HR]
TO DISK = N'/opt/mssql/lib/HR_Backup_SQLServer.bak' 
WITH NOFORMAT, NOINIT,
NAME = N'SQLHR-Full Database Backup', SKIP, NOREWIND, NOUNLOAD, STATS = 10;

use master;
RESTORE DATABASE [HR] 
FROM DISK = N'/opt/mssql/lib/HR_Backup_SQLServer.bak';
...
--CREATE UNIQUE INDEX idx_employee_jobhistory
